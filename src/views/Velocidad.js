...
const Velocidad = () => {
  ...
  return (
    <div className="container">
      <h3 className="m-4">Análisis de la velocidad</h3>
      <h4 className="m-4">
        Determinación de la velocidad a traves de la aceleración
      </h4>
      ...
      <div className="mb-3">
        <h4>Aceleración y velocidad </h4>
      </div>

      <div className="form-control mb-5">
        <h5>La velocidad promedio fué de {promedioVT.toFixed(2)} m/s</h5>
      </div>
      <div className="mb-3">
        <h4>
          Gráfico de la aceleraión y de la velocidad en funcion del tiempo
        </h4>
      </div>
      <div className="mb-5">
        {" "}
      ...
      <div className="mb-3">
        <h4>Gráfico de la aceleraión y la velocidad en la fase propulsiva</h4>
      </div>
      <div className="mb-5">
        {" "}
        <Chart
